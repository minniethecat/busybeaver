---
description: A knowledge wiki for "Yashka" — this page is auto-generated from book metadata
id: About
...
This wiki is built around *Yashka*, organizing the source text into searchable, cross-referenced encyclopedia pages.
...
| --- | --- |
| Title | Yashka |
| Estimated length | ~1,136,402 characters |
| Expected pages | ~1,136 pages |
