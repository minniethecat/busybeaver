---
description: A knowledge wiki for "Hester" — this page is auto-generated from book metadata
id: About
...
This wiki is built around *Hester*, organizing the source text into searchable, cross-referenced encyclopedia pages.
...
| --- | --- |
| Title | Hester |
| Estimated length | ~2,187,500 characters |
| Expected pages | ~2,187 pages |
