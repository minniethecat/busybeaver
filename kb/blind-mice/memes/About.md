---
description: A knowledge wiki for "Blind Mice" — this page is auto-generated from book metadata
id: About
...
This wiki is built around *Blind Mice*, organizing the source text into searchable, cross-referenced encyclopedia pages.
...
| --- | --- |
| Title | Blind Mice |
| Estimated length | ~549,772 characters |
| Expected pages | ~549 pages |
