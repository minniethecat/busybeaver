---
description: A knowledge wiki for "On the Eve" — this page is auto-generated from book metadata
id: About
...
This wiki is built around *On the Eve*, organizing the source text into searchable, cross-referenced encyclopedia pages.
...
| --- | --- |
| Title | On the Eve |
| Estimated length | ~316,212 characters |
| Expected pages | ~316 pages |
