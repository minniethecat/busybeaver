---
description: A knowledge wiki for "常识" — this page is auto-generated from book metadata
id: About
...
This wiki is built around *常识*, organizing the source text into searchable, cross-referenced encyclopedia pages.
...
| --- | --- |
| Title | 常识 |
| Estimated length | ~124,411 characters |
| Expected pages | ~124 pages |
