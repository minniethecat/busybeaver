---
description: 'Lecture 23: GENERAL THEORY OF THE NEUROSES.'
id: chapter-23
label: "Chapter 23: General Theory of the Neuroses"
tags: ["chapter"]
type: chapter
---
...
[023-001]IN the layman's eyes the symptom shows the nature of the disease, and
...
[023-002]Of course, the only tangible thing left over after the removal of the
...
[023-003]The symptoms,—of course, we are dealing here with psychic (or
...
[023-004]As to the neurotic symptoms, we already know that they are the result of
...
symptom; they become reconciled throughthe compromise of a symptom
...
[023-005]Here the development toward perversion branches off sharply from that of
...
[023-006]Such an evasion is offered by the fixations established in the course of
...
fulfillment of awish-phantasy, is first built up in the
...
[023-007]The exit to reality is closed only through the condition of sleep.

[023-008]You see, this evasion which the libido finds under the conditions of the
...
[023-009]Where, now, can the libido find the fixations which it must have in
order to force its way through the suppressions? In theactivities and
...
[023-010]I do not see any theoretical difficulties here. Congenital tendencies
...
[023-011]The libido fixation of adults, which we have referred to as
...
::: table pn=023-012
| Cause of theneurosis | == | Disposition asdetermined bylibido fixation| | + | accidentalexperiences(traumaticelement) |

|---|---|---|---|---|---|

|  |  |  |  |  |

[023-013]| Sexual constitution(pre-historic experience) |  | Infantileexperience |
...
[023-015]Let us devote a little time to the consideration of the fact that
...
[023-016]With respect to therapeutic work their importance remains undiminished.

[023-017]But when we do not take this into account we can herein readily
...
[023-018]A decision on this matter will hardly be difficult for us. The statement
...
in the form ofanxiety hysteria. What this implies we shall learn upon
...
[023-019]However, there are cases, as already stated, in which this childish
...
[023-020]Secondly, we must admit that the universal regression of the libido to
...
only if we think of it as stabilizinga definite amount of libidinous
...
[023-021]These relations have a certain interest for that pedagogy which assumes
...
[023-022]Let us return to the consideration of the symptoms. They serve as
substitutes for the gratification which has been forborne, by a
regression of the libido to earlier days, with a return toformer
development phases in their choice of object and in their organization.

[023-023]We learned some time ago that the neurotic is held fast somewhere in his
...
[023-024]There is something else that makes the symptoms appear remarkable and
...
world, we have a physical change, in other words, an internalreaction
in place of an external one, an adjustment instead of an activity.

[023-025]Viewed from a phylogenetic standpoint, this expresses a very significant
...
[023-026]I have indicated that we must still become familiar with a new factor.

[023-027]It is something really surprising and confusing. You know that by
...
the representation of actual experiences to which we may ascribean
...
[023-028]After reflecting a bit we can easily understand what is so confusing in
...
[023-029]And yet this is obviously the only correct attitude toward these
psychological products because they are, in a sense, real. It isa fact
...
undergone the experience which he imagines. These phantasies possesspsychologicalreality in contrast tophysicalreality, and so we
gradually come to understand thatin the realm of neuroses the
psychological reality is the determining factor.

[023-030]Among the experiences which recur continually in the early history of
...
the doctor. In the famousStruwelpeterby the pediatrist Hoffman, of
...
between his parents or some othergroup-ups, and it cannot be disproved
that the childsubsequentlyunderstands this impression, and may react
...
so frequently does, an intercourse which was not face to face,more
ferarum, there is no longer any doubt that this phantasy is derived
...
[023-031]Seduction by older children, or children of the same age, is much more
...
[023-032]We cannot avoid the impression that such experiences of childhood are in
...
acquainted with. Whence comes the need for thesephantasies, and the
...
will think very far-fetched. I am of the opinion that theseprimal
phantasies—so I should like to term these, and certainly some others
...
[023-033]What we have just discussed makes it necessary for us to enter further
...
enjoys that freedom from external compulsion that he haslong since
...
[023-034]The best known productions of phantasy are the so-called "day dreams,"
...
[023-035]The significance of phantasy for the development of symptoms will become
...
[023-036]We shall neither retract this statement nor correct it, but we shall
...
derivatives, are still held in presentations of the phantasy, with acertain degree of intensity. The libido need only retire to the
...
contrast, so long as a certain condition was observed—a conditionquantitativein nature that is now disturbed by the flowing back of
...
[023-037]The return of the libido to phantasy is an intermediate step on the road
to symptom development and well deserves a special designation. C. G.

[023-038]Jung coined for it the very appropriate name ofintroversion, but
...
[023-039]You have certainly noticed that in the last discussions I have
...
[023-040]Or, to put it in another way, adynamicconception alone of these
psychic processes is not enough; there is need of aneconomicviewpoint. We must say to ourselves that the conflict between two
impulses is not released before certain occupation-intensities have been
reached, even though the qualitativeconditions have long been potent.

[023-041]Similarly, the pathogenic significance of the constitutional factors is
guided by how muchmoreof a given component impulse is present in the
...
ailments. It depends uponwhat amountof unused libido a person can
hold freely suspended, and uponhow large a fractionof the libido he
...
[023-042]So much I wanted to tell you about symptom development in the neuroses.

[023-043]Yes, but do not let me neglect to emphasize this especially: everything
...
[023-044]Before I leave you today I should like to have your attention for a
...
[023-045]He wants to achieve honor, power, riches, fame and the love of women.

[023-046]But he lacks the means of achieving these satisfactions. So like any
...
wishes, all of which might easily point the way to neurosis. Agreat
