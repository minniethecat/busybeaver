---
description: 'Lecture 11: THE DREAM.'
id: chapter-11
label: "Chapter 11: The Dream"
tags: ["chapter"]
type: chapter
---
...
[011-001]IF you have mastered dream censorship and symbolic representation, you
...
[011-002]We are now in a position to resume work which we attempted, with very
...
[011-003]I hope you will never again confuse these two. If you have achieved
this, you have probably accomplished more in the understanding of the
dream than the majority of the readers of myInterpretation of Dreams.

[011-004]Let me remind you once more that this process, which changes the latent
into the manifest dream, is calleddream-work. Work which proceeds in
the opposite direction, from the manifest dream to the latent, is ourwork of interpretation. The work of interpretation attempts to undo
...
into visual pictures. Here weneed no interpretation, but only a
retracing of these transformations. Whatever dream-work has been added
to other dreams, we calldream distortion, and this can be annulled by
our work of interpretation.

[011-005]The comparison of many dream interpretations has rendered it possible
...
[011-006]The first process of the dream-work iscondensation. By this we
...
[011-007]Condensation may occasionally be absent, but as a rule it is present,
...
[011-008]Certain latent elements are entirely omitted; 2. only a fragment of the
...
[011-009]If you wish, you may reserve the term "condensation" for this last
...
[011-010]The shaping of such compound formations must be of great importance to
the dream-work, for we can prove, (by the choiceof a verbal expression
...
of slips of the tongue. You recall the young man who wished toinscorta woman. Furthermore, there are jokes whose technique may be traced to
...
[011-011]These thoughts are transformed into something else by the dream-work,
...
[011-012]Although condensation renders the dream opaque, one does not get the
...
[011-013]The results of condensation may be quite extraordinary. With its help,
...
[011-014]The consequence of condensation for the relation between latent and
...
[011-015]Dream-work therefore accomplishes a very unusual sort of transcription
...
[011-016]The second process of the dream-work isdisplacement. Fortunately we
...
[011-017]Substitution by allusion is known to our conscious thinking also, but
...
[011-018]They retain, however, the condition of intelligibility; the joke would
...
[011-019]The displacement of emphasis is unheard of as a means of expressing
...
[011-020]The third process of the dream-work is the most interesting from a
psychological point of view. It consists of thetranslationof
...
[011-021]It is evident that this process is not simple. In order to get an idea
...
[011-022]With the abstract words you could use all sorts of artifices. You will,
...
possible, and so youwill be glad to learn that you can represent the
"possession" of an object by the actual physical straddling of it.[32]The dream work does the same thing. Under such circumstances you can
...
[011-023]In the representation of parts of speech that denote thought relations,
such asbecause,therefore,but, etc., you have no such aids;
...
content of the dream thought into its rawmaterial of objects and
...
[011-024]By continually comparing dream thought with the manifest dream that
...
good example of this. The opinion expressed here is: "It wasnonsenseto marry so early."

[011-025]In the same way, we discover in interpretation what is the significance
...
correspond to nothing in thelatent dream thought; they are occasioned
throughout by the working of the dream censor and are equivalent to an
unsuccessful attempt at suppression.

[011-026]One of the most surprising discoveries is the manner in which the
...
[011-027]The development of languages furnishes us with a welcome analogy for
...
little—were expressed by the same root word. (The Contradictory Sense

of Primitive Words.) In old Egyptian,kenoriginally meant both

[011-028]strong and weak. In conversation, misunderstanding in the use of such
...
the alphabetical signs, ifken,weak, was meant, the picture of a
...
it denoted. In this way, fromkenmeaning both strong and weak, there
was derived aken, strong, and aken, weak. It is said that not only
...
[011-029]In Latin there are still such words of double meaning:
altus—high, deep, andsacer, sacred, accursed.

[011-030]As examples of modifications of the same root, I cite:
clamare—to scream,clam—quiet, still, secret;
siccus—dry,succus—juice.

And from the German:

[011-031]Stimme—voice,stumm—dumb.

[011-032]The comparison of related tongues yields a wealth of examples:

English:lock; German:Loch—hole,Lücke—gap.

[011-033]English:cleave; German:kleben—to stick, to adhere.

[011-034]The Englishwithout, is to-day used to mean "not with"; that "with"
had the connotation of deprivation as well as that of apportioning, is
apparent from the compounds:withdraw,withhold. The Germanwieder, again, closely resembles this.

[011-035]Another peculiarity of dream-work finds it prototype in the development
...
[011-036]Balken(beam)—Kloben(mallet)—club.

From the Latin and the German:

[011-037]capere(to seize)—packen(to seize, to grasp).

[011-038]Inversions such as occur here in the single word are effected in a very
...
[011-039]These features of the dream-work may be calledarchaic. They are
...
[011-040]Now for some other aspects of the matter. In the dream-work it is
...
dream-work therefore puts the thoughts through aregressivetreatment,
...
[011-041]This, then, is the dream-work. In view of the processes that we have
...
[011-042]It is natural that the manifest dream should lose its importance for us.

[011-043]It must be a matter of indifference to us whether it is well composed or
...
thoughts which correspond to the elements in the latent dream; yet atother times we are convinced that what belongs together in thought has
been torn apart in the dream.

[011-044]As a general rule we must refrain from trying to explain one part of the
...
so-calledsecondary treatment, whose function it is to develop
...
[011-045]On the other hand, we must not over-estimate the dream-work, nor
...
[011-046]Under these conditions it is not surprising that the interest which has
...
maintainsof the latter what can hold only for the former. It is odd
...
that is, theforminto which the latent dream thoughts have been
translated by the dream-work.

[011-047]Dream-work is a process of a very peculiar sort, the like of which has
...
[011-048]I know too that we cannot as yet estimate the entire contribution that
...
[011-049]The time has probably come, however, to illustrate separately, by
